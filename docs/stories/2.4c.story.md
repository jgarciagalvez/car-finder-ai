...
- `apps/api/src/scripts/translate.ts` - Fixed hasRequiredFeatures() to check sourceEquipment before translation
...
- `packages/db/src/repositories/vehicleRepository.ts` - Added findVehiclesNeedingTranslation() method
...
- `apps/api/package.json` - Added "translate" script
